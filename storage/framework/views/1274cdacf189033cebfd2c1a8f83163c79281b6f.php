...
<head>
	...
	<link rel="stylesheet" href="<?php echo e(URL::asset('all.min.css')); ?>" />
	<link rel="stylesheet" href="<?php echo e(URL::asset('swiper.min.css')); ?>" />
	<link rel="stylesheet" href="<?php echo e(URL::asset('framework.css')); ?>" />
    		...
    		<div class="message">
    			...
    			<div class="msg-input"> 
    				...
    				<form name="myForm" action="/login" method="get">
						...
						<input type="text" name="email" id="emailLogin" placeholder="email"> <br>
						<input type="text" name="password" id="passwordLogin" placeholder="password">
						<br>
						<br>
						<a href="login.php">
...
</html><?php /**PATH D:\Downloads\Laravel trial\laravel.trial\my-blog\resources\views/index.blade.php ENDPATH**/ ?>